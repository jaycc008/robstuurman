	...
	v-row.float-left.mb-11
		...
		v-col.offset-sm-1.offset-lg-0(cols="12" sm="10" md="5" lg="4")
			v-card.rounded-lg.full-height.d-inline-flex.flex-column(color="skin" flat)
				...
				p.mx-8.small.tertiary--text De tweede versie van Spirituele Beurs SOULS in de Beckart in Nijnsel is op zondag 2 april 2023 vanaf 10.00, entree kost slechts €2,-. Voor het laatste nieuws hou onze Facebook pagina in de gaten.
